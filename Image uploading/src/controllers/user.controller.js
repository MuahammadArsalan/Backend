...
const uploadImage=async(req,res) =>{
    ...
    if (!req.file) {
        res.status(400).json({messaage:"No Image file uploaded"})
    }
...
if (!uploadResult) {
    res.json({messaage:"error occured while file uploaded"})
}
res.json({messaage:"file uploaded successfully",  imageUrl:uploadResult})
...
export  {registerUser, loginUser,logOut,refreshToken,uploadImage} 